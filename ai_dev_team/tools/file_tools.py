...
def write_file_to_outputs(file_path: str, content: Optional[Any]) -> str:
    ...
    # Coerce None or non-string content to a safe string
    if content is None:
        safe_content: str = ""
...
def write_file_tool(file_path: str, content: Optional[Any]) -> str:
